...
namespace LiveDescribe.Utilities
{
    ...
    public class ProgressFileCopier
    {
        ...
        /// <param name="lpData">Optional argument to be passed to the callback function. Can be
        /// set to NULL.</param>
        /// <param name="pbCancel">If set to true during copying, then the operation will be
        /// cancelled.</param>
        ...
        /// <param name="totalBytesTransferred">The total amount of bytes copied since the start of
        /// the operation.</param>
        /// <param name="streamSize">The total size of the current file stream in bytes.</param>
        /// <param name="streamBytesTransferred">Number of bytes in the stream that have been
        /// transferred since the beginning of the operation.</param>
        ...
        private enum CopyFileFlags : uint
        {
            ...
            /// lpExistingFileName and lpNewFileName as those used in the call that failed. This
            /// can significantly slow down the copy operation as the new file may be flushed
